...
func ChooseVersion(client *eclcloud.ProviderClient, recognized []*Version) (*Version, string, error) {
	...
	var resp response
	_, err := client.Request("GET", client.IdentityBase, &eclcloud.RequestOpts{
		JSONResponse: &resp,
		OkCodes:      []int{200, 300},
	})
