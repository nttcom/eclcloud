...
import (
	...
	"github.com/nttcom/eclcloud/ecl/db/v1/instances"
...
func (opts CreateOpts) ToConfigCreateMap() (map[string]interface{}, error) {
	return eclcloud.BuildRequestBody(opts, "configuration")
}
...
func Get(client *eclcloud.ServiceClient, configID string) (r GetResult) {
...
func Update(client *eclcloud.ServiceClient, configID string, opts UpdateOptsBuilder) (r UpdateResult) {
...
func Replace(client *eclcloud.ServiceClient, configID string, opts UpdateOptsBuilder) (r ReplaceResult) {
	b, err := opts.ToConfigUpdateMap()
	if err != nil {
		r.Err = err
		return
...
func Delete(client *eclcloud.ServiceClient, configID string) (r DeleteResult) {
...
// configuration group.
func ListInstances(client *eclcloud.ServiceClient, configID string) pagination.Pager {
...
func ListDatastoreParams(client *eclcloud.ServiceClient, datastoreID, versionID string) pagination.Pager {
...
// operation.
func GetDatastoreParam(client *eclcloud.ServiceClient, datastoreID, versionID, paramID string) (r ParamResult) {
...
// DatastoreID.
func ListGlobalParams(client *eclcloud.ServiceClient, versionID string) pagination.Pager {
...
// DatastoreID.
func GetGlobalParam(client *eclcloud.ServiceClient, versionID, paramID string) (r ParamResult) {
