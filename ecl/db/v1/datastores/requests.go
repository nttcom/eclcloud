...
func Get(client *eclcloud.ServiceClient, datastoreID string) (r GetResult) {
...
// datastore type.
func ListVersions(client *eclcloud.ServiceClient, datastoreID string) pagination.Pager {
...
func GetVersion(client *eclcloud.ServiceClient, datastoreID, versionID string) (r GetVersionResult) {
