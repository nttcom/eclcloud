...
import (
	db "github.com/nttcom/eclcloud/ecl/db/v1/databases"
	"github.com/nttcom/eclcloud/ecl/db/v1/users"
...
func (opts CreateOpts) ToInstanceCreateMap() (map[string]interface{}, error) {
	...
	if opts.FlavorRef == "" {
		return nil, eclcloud.ErrMissingInput{Argument: "instances.CreateOpts.FlavorRef"}
	}
...
func Create(client *eclcloud.ServiceClient, opts CreateOptsBuilder) (r CreateResult) {
	...
	_, r.Err = client.Post(baseURL(client), &b, &r.Body, &eclcloud.RequestOpts{OkCodes: []int{200}})
	return
}
...
func EnableRootUser(client *eclcloud.ServiceClient, id string) (r EnableRootUserResult) {
	_, r.Err = client.Post(userRootURL(client, id), nil, &r.Body, &eclcloud.RequestOpts{OkCodes: []int{200}})
	return
}
...
// otherwise.
func IsRootEnabled(client *eclcloud.ServiceClient, id string) (r IsRootEnabledResult) {
...
func Restart(client *eclcloud.ServiceClient, id string) (r ActionResult) {
...
func Resize(client *eclcloud.ServiceClient, id, flavorRef string) (r ActionResult) {
...
func ResizeVolume(client *eclcloud.ServiceClient, id string, size int) (r ActionResult) {
...
func AttachConfigurationGroup(client *eclcloud.ServiceClient, instanceID string, configID string) (r ConfigurationResult) {
	b := map[string]interface{}{"instance": map[string]interface{}{"configuration": configID}}
	_, r.Err = client.Put(resourceURL(client, instanceID), &b, nil, &eclcloud.RequestOpts{OkCodes: []int{202}})
	return
}

// DetachConfigurationGroup will dettach configuration group from the instance
func DetachConfigurationGroup(client *eclcloud.ServiceClient, instanceID string) (r ConfigurationResult) {
