...
type CreateOpts struct {
	...
	// or public), referenced by the eclcloud.Availability type.
	Availability eclcloud.Availability `json:"interface" required:"true"`
...
func (opts CreateOpts) ToEndpointCreateMap() (map[string]interface{}, error) {
	return eclcloud.BuildRequestBody(opts, "endpoint")
}
...
type ListOpts struct {
	// Availability is the interface type of the Endpoint (admin, internal,
	// or public), referenced by the eclcloud.Availability type.
	Availability eclcloud.Availability `q:"interface"`
...
type UpdateOpts struct {
	// Availability is the interface type of the Endpoint (admin, internal,
	// or public), referenced by the eclcloud.Availability type.
	Availability eclcloud.Availability `json:"interface,omitempty"`
