...
type ListOpts struct {
	...
	// Sort sorts the results using the new style of sorting. See the Enterprise Cloud
...
func Create(client *eclcloud.ServiceClient, opts CreateOptsBuilder) (r CreateResult) {
	...
	_, r.Err = client.Post(createURL(client), b, &r.Body, &eclcloud.RequestOpts{OkCodes: []int{201}})
	return
}
