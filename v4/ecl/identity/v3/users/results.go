...
import (
	...
	"github.com/nttcom/eclcloud/v4/internal"
	"github.com/nttcom/eclcloud/v4/pagination"
	"time"
)

// User represents a User in the Enterprise Cloud Identity Service.
type User struct {
...
func (r *User) UnmarshalJSON(b []byte) error {
	...
	var s struct {
		...
		PasswordExpiresAt eclcloud.JSONRFC3339MilliNoZ `json:"password_expires_at"`
	}
